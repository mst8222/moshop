            ...
            <div class="content">
                ...
                <form id="w0" action="/admin/category/save" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="cat_name" maxlength="255" value="{{.categ.Cat_name}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sort_order" maxlength="255" value="{{.categ.Sort_order}}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="show_in_nav">
                            <option value="0" {{if eq .categ.Show_in_nav 0}}selected{{end}}>否</option>
                            <option value="1" {{if eq .categ.Show_in_nav 1}}selected{{end}}>是</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="is_show">
                            <option value="1" {{if eq .categ.Is_show 1}}selected{{end}}>是</option>
                            <option value="0" {{if eq .categ.Is_show 0}}selected{{end}}>否</option>
                        </select>
